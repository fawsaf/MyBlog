...
if (isset($_POST['upd'])) {
    ...
    $sql2 = "UPDATE posts SET title = '$title', description = '$description', slug = '$slug', post_cat='$category' WHERE id = $id";
        ...
        <form action="" method="POST" class="w3-container">
            ...
            <p>
                ...
                <p>Category list:
                    ...
                    <input type="number"name="category" min="1" max="4" value="<?php echo $category; ?>">
                </p>
            </p>
            <p>  
            ...
            <div class="w3-text-red">
                <?php
                    echo "<a href='/$url_path/del.php?id= $row[id]'
